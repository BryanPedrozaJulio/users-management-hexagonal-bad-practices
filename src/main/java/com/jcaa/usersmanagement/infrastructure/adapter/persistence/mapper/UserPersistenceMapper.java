...
public class UserPersistenceMapper {
  ...
  // Regla 4: todos los métodos declarados static — no usan estado de instancia
  ...
  public static List<UserModel> fromResultSetToModelList(final ResultSet resultSet)
          throws SQLException {
