...
public final class DependencyContainer {
  ...
  public DependencyContainer() {
    ...
    // Regla 19 y 22: eliminado userRepository.init() — no hay temporal coupling
    // ni acoplamiento rígido al tipo concreto para llamar a init()
  ...
  private static Connection buildDatabaseConnection(final AppProperties properties) {
    ...
    // Regla 4: DatabaseConnectionFactory es @UtilityClass — se llama directamente sin instanciar
