 ...
 *
 * Casos cubiertos:
 * - execute() retorna la lista de usuarios cuando el puerto devuelve resultados
 * - execute() retorna lista vacía cuando no hay usuarios
 */
...
class GetAllUsersServiceTest {
  ...
  void shouldReturnUsersFromPort() {
    ...
    // Assert
    // Regla 11: reemplazadas aserciones débiles por las más expresivas y correctas
