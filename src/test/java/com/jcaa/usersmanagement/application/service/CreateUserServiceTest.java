...
// Regla 11: agregado @DisplayName a la clase con descripción del comportamiento
...
class CreateUserServiceTest {
  ...
  @Test
  // Regla 11: agregado @DisplayName descriptivo al método
  @DisplayName("should save user and send notification when email is new")
  void shouldSaveUserAndNotifyWhenEmailIsNew() {
    ...
    // Assert
    // Regla 11: reemplazado assertTrue(x != null) por assertNotNull(x)
    assertNotNull(result);
    // Regla 11: reemplazado assertTrue(x.equals(y)) por assertEquals(y, x)
  ...
  @Test
  // Regla 11: agregado @DisplayName descriptivo al método
  @DisplayName("should throw ConstraintViolationException when command has invalid fields")
